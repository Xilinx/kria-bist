...
supported_boards = {
    'kv260': [
        {'label': 'ar1335_ap1302_ximagesink', 'pipeline': 'isp_vcap_csi', 'width': 640, 'height': 480, 'fps': 30, 'fmt': 'NV12', 'tpg_pattern': 2},
        ...
        {'label': 'ar1335_filesink', 'pipeline': 'ias_vcap_csi', 'width': 3840, 'height': 2160, 'fps': 30, 'fmt': 'NV12', 'tpg_pattern': 1},
